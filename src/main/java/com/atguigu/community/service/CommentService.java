...
import com.atguigu.community.Dao.CommentMapper;
...
public class CommentService implements CommunityConstant {
    ...
    //pageNum从1开始，pageSize代表每页大小
    public PageInfo<Comment> findCommentsByEntity(int entityType,int entityId,int pageNum,int pageSize){
        PageHelper.startPage(pageNum,pageSize);
        List<Comment> commentList = commentMapper.selectCommentsByEntity(entityType, entityId);
        PageInfo<Comment> page = new PageInfo<Comment>(commentList);
